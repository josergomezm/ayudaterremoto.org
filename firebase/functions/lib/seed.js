...
async function seedDemoData() {
    const meta = firebase_1.db.doc("meta/seed");
    ...
    for (const i of incidents)
        batch.set(firebase_1.db.doc(`incidents/${i.id}`), i);
    batch.set(firebase_1.db.doc("announcements/1"), {
        id: "1",
        category: "urgent",
    ...
    batch.set(firebase_1.db.doc("vouchCodes/DEMO1234"), { code: "DEMO1234", used: false, voucher: "seed", createdAt: now });
